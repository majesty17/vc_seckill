...
#include <time.h>
//★★★★两个比较重要的参数★★★★
int editor_handle=0x209E8;			//监视文本框句柄
int submit_val=100;					//提交周期 ms
//★★★★两个比较重要的参数★★★★
namespace seckill {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(87, 255);
...
public: static void Form1::ThreadSubmit(){
			while(Form1::thread_sign_sub && (Form1::val<Form1::limit)){
				...
				//倒计时时段
				else if(Form1::timeleft<200 || less_than(20)){
					//submit，关键！
					Form1::submit();
				}
...
private: System::Void button7_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			IntPtr hh=(IntPtr)editor_handle;
			RefWinApi::SendMessage((void*)hh,(unsigned int)0x000C,(unsigned int)100,(unsigned int)buff);	//0x000D is WM_GETTEXT
			/*void* h=RefWinApi::FindWindowA(NULL,(void*)"陕西煤炭交易客户端") ;
			if(NULL==h)return;
			RefWinApi::PostMessage((void*)h,0x0100,(unsigned int)System::Windows::Forms::Keys::Menu,NULL);
			RefWinApi::PostMessage((void*)h,0x0104,(unsigned int)System::Windows::Forms::Keys::O,NULL);*/
